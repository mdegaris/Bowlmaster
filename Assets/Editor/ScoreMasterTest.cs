...
public class ScoreMasterTest
{
    ...
    [Test]
    public void T20TestImmediateStrikeBonus()
    {
        int[] rolls = { 5, 5, 3 };
        int[] frames = { 13 };
        Assert.AreEqual(frames.ToList(), ScoreMaster.ScoreFrames(rolls.ToList()));
    ...
    [Test]
    public void T22StrikeInLastFrame()
    {
